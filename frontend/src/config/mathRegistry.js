...
//Euler
import EulerControls from '../data/math/euler/EulerControls';
import EulerVisual from '../data/math/euler/EulerVisual';
import EulerExplanation from '../data/math/euler/EulerExplanation';
...
export const MATH_REGISTRY = {
  ...
  euler_function: {
    visual: EulerVisual,
    controls: EulerControls,
    explanation: EulerExplanation,
    initialParams: { stepSize: 0.5, steps: 5 },
  },
};
